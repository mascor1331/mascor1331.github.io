...
function generateContactListElement(contact,data) {
    return '<li class="flex-item"><span class="orange-text">'+contact+'</span><span class="white-text">'+data+'</span></li>';
}
...
function addSchool(school) {
    ...
    var HTMLschoolName = '<a href="'+school.url+'">'+school.name;
    var HTMLschoolDegree = ' -- '+school.degree+'</a>';
    var HTMLschoolDates = '<div class="date-text">'+school["degree dates"]+'</div>';
    var HTMLschoolLocation = '<div class="location-text">'+school.location+'</div>';
    var HTMLschoolMajor = '<em><br>Major:'+school.majors+'</em>';
    return HTMLschoolStart+HTMLschoolName+HTMLschoolDegree+HTMLschoolDates+HTMLschoolLocation+HTMLschoolMajor+'</div>';
}
...
function addOnlineCourse(course) {
    var HTMLschoolStart = '<div class="education-entry">';
    var HTMLonlineTitle = '<a href="#">'+course.title;
    var HTMLonlineSchool = ' - '+course.school+'</a>';
    var HTMLonlineDates = '<div class="date-text">'+course.dates+'</div>';
    var HTMLonlineURL = '<br><a href="#">'+course.url+'</a>';
    return HTMLschoolStart+HTMLonlineTitle+HTMLonlineSchool+HTMLonlineDates+HTMLonlineURL+'</div>';
}
    ...
    */
    function createMapMarker(placeData) {
        ...
        google.maps.event.addListener(marker, 'click', function() {
            // your code goes here!
            // marker.title = infoWindow.content;
